class DataTableManager {
   ...
   */
  createFilterMap() {
    const filterElements = document.querySelectorAll("select[data-datatable-filter-column]");
    return new Map(Array.from(filterElements).map((el) => [el.getAttribute("data-datatable-filter-column"), el]));
  }
